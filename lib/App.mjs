...
class App {
    constructor({ timeZone, telegramBotToken, devicesServerHost, devicesServerPort, database }) {
        setTimeZone(timeZone);

        this._devicesServer = new DevicesServer({ devicesServerHost, devicesServerPort });
