...
class App {
    constructor({ timeZone, telegramBotToken, telegramBotUpdates, httpServerPort, database }) {
        ...
        this._clientsServer = new ClientsServer({ httpServer, telegramBotToken, telegramBotUpdates });
